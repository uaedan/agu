...
NADEAU--150525
AIM: 
      =  SMOOTH ptil-REF (i.e., psERM)
        . PYTHON code
        . Smooth over an swlen samples moving window
        . Beginning End-effect smoothing is phased in until full window length
        . Ending End-effect smoothing is same but phased out after full window length
        . Smooths over all samples, steps of 1.
        . Testing:
        . Median smoothing wi swlen is used
              + within each window use V50 
                ( I think this will reduce quake effects somewhat. )
"""
...
bS=0+0
bE=0+0
print >> sys.stderr, "stS:   ",tsS
print >> sys.stderr, "stE:   ",tsE
print >> sys.stderr, "swlen: ",swlen
print >> sys.stderr, "bS:   ",bS
print >> sys.stderr, "bE:   ",bE
#print "BEGINNING-END-EFFECT:"
#print  "tsI bS bE nB n50:"
while tsI < int(swlen/2.):
    bE=tsI+(int((swlen/2.0)+0.5)-1)
    nB=bE-bS+1
